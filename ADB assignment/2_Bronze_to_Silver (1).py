...
update_match = "bronze.surrogateKEY = clean.surrogateKEY"  #matching movie column in clean sliver dataframe to the surrogateKEY column in the bronze table
...
spark.read.load(silverPath).display()
